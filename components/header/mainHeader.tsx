    ...
    <header className="w-full py-3 px-3 flex items-center justify-between">
      <div className="flex gap-2 items-center col-span-1">
        ...
        <Link href="/" aria-label="로고이미지 (메인페이지로 이동)">
          <div className="p-1 w-8 h-8 bg-gradient-to-r from-cyan-500 to-blue-500 rounded-md hover:opacity-90 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-teal-700 transition duration-200 ease-in-out">
