  ...
  return (
    <header className="w-full h-20 grid grid-cols-8 items-center gap-2">
      <div className="w-60 col-span-1">
        <div
          className="p-1 w-10 h-10 bg-gradient-to-r from-cyan-500 to-blue-500 rounded-md hover:opacity-90 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-teal-700 transition duration-200 ease-in-out"
